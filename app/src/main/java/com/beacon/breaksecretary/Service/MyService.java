package com.beacon.breaksecretary.Service;
...
import static com.beacon.breaksecretary.Application.App.CHANNEL_ID;
...
public class MyService extends Service implements BeaconConsumer, Observer {
    ...
    private User mUser;
    private int Limit_using_time, Limit_reserving_time, Limit_empty_time;
